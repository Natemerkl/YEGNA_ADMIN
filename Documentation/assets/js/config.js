/**
* Theme: YEGNA - Responsive Bootstrap 5 Admin Dashboard
* Author: MERKL.DEV
...
class Config {
     ...
     setConfig() {
          ...
          var savedConfig = localStorage.getItem("__YEGNA_CONFIG__");
          // var savedConfig = sessionStorage.getItem("__YEGNA_CONFIG__");
     ...
     init() {
          try {
               ...
               localStorage.setItem('__YEGNA_CONFIG__', JSON.stringify(this.config));
               this.setConfig();
          }
     }
}
