    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="mt-3">Getting Started with YEGNA</h4>
                <p>Welcome to YEGNA Dive into basic for a swift on boarding experience</p>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4 class="card-title">Getting Started with YEGNA</h4>
