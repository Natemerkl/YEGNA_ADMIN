            ...
            <div class="card-body">
                <div class="">
                    ...
                    <div class="d-flex align-items-center gap-2 mb-2">
                        ...
                        <p class="mb-0 fs-14">Website <a href="#!" class="text-primary fw-semibold">www.YEGNA.co</a></p>
                    </div>
                    <div class="d-flex align-items-center gap-2 mb-2">
                        <div class="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
    ...
    <div class="col-xl-4 col-lg-5">
        ...
        <div class="card overflow-hidden z-1">
            <div class="card-body text-center">
                ...
                <p class="d-flex align-items-center border p-2 rounded-2 border-dashed bg-body text-start mb-0">https://YEGNA-mileage.com <a href="#!" class="ms-auto fs-4"><i class="ti ti-copy"></i></a></p>
            </div>
        </div>
    </div>
</div>
