    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <div class="d-flex align-items-center">
                ...
                <!-- Menu Toggle Button -->
                <div class="topbar-item">
                    <h4 class="fw-bold topbar-button pe-none text-uppercase mb-0">{{ $title ?? 'YEGNA' }}</h4>
                </div>
            </div>
                ...
                <div class="position-relative ms-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="#!" class="text-dark fw-medium">YEGNA.docs</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="position-relative ps-4">
                        <div class="mb-4">
                            ...
                            <div class="ms-2">
                                <h5 class="mb-1 text-dark fw-semibold fs-15">YEGNA Application UI v2.0.0 <span
